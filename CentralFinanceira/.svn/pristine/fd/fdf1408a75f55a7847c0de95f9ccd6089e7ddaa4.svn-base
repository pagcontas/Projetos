package br.com.jsoft.centralfinanceira.bo.email;

import br.com.jsoft.centralfinanceira.bo.configuracao.ErroSistemaBO;
import br.com.jsoft.centralfinanceira.modelo.email.Attachment;
