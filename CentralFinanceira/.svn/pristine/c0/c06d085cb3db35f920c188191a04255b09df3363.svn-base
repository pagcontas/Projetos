...
public class FatosValeGas implements Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private ConvenioGas conveniogas;
    ...
    public ConvenioGas getConveniogas() {
        return conveniogas;
    }

    public void setConveniogas(ConvenioGas conveniogas) {
        this.conveniogas = conveniogas;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final FatosValeGas other = (FatosValeGas) obj;
