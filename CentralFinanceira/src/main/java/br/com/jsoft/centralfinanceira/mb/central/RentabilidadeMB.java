...
public class RentabilidadeMB extends AbstractBaseBean<FatosBoletos> implements Serializable {
    ...
    public void gerarXLS() {
        ...
        params.put("totalCustoOperacionalSite", totalComissaoConvenioBoletosSite());
        ...
        params.put("totalComissaoLojaBB", totalComissaoLojaBoletosOps());
        ...
        params.put("porcentagemRecDesp", porcentagemLiquida(totalLiquido(), totalReceitaDespesas()));
