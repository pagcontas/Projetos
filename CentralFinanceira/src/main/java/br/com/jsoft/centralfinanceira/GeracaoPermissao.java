...
public class GeracaoPermissao {
    ...
    public void generate() {
        ...
        //Tipo Loja
        create(new Permissao("tipoLoja", "Tipo Loja", true), "cadastrosbasicos");
        ...
        create(new Permissao("tipoLoja.list", "Consulta de Tipo Loja", "/view/central/cadastrosbasicos/tipoLoja/listTipoLoja.jsf", true), "tipoLoja");
...
//Tipo Receita
        ...
        //Menu Graficos
        create(new Permissao("maps", "Mapas", true), null);
