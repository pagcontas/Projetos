...
public class FatosBanPop implements Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private ConvenioBanPop conveniobanpop;
    ...
    public ConvenioBanPop getConveniobanpop() {
        return conveniobanpop;
    }

    public void setConveniobanpop(ConvenioBanPop conveniobanpop) {
        this.conveniobanpop = conveniobanpop;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FatosBanPop)) {
            return false;
        }
        FatosBanPop other = (FatosBanPop) object;
