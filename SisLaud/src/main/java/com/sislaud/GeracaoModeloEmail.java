...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        salvarModeloEmail("[SisLaud] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[SisLaud] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
