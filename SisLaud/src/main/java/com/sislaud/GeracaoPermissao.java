...
import com.sislaud.dao.controleacesso.PermissaoDAO;
...
public class GeracaoPermissao {
    ...
    public void generate() {
        ...
        //Laudo
        create(new Permissao("laudo", "Laudo", true), null);
        create(new Permissao("laudo.create", "Cadastro de Laudo", "/view/laudo/createLaudo.jsf", true), "laudo");
        create(new Permissao("laudo.list", "Consulta de Laudo", "/view/laudo/listLaudo.jsf", true), "laudo");
        create(new Permissao("laudo.audit", "Auditoria de Laudo"), "laudo");
        create(new Permissao("laudo.delete", "Exclusão de Laudo"), "laudo");
        //Dowload Arquivos

        create(new Permissao("dowloadArquivos", "Dowload Arquivos", "laudo"), null);
        create(new Permissao("dowloadArquivos.create", "Cadastro de Dowload Arquivos", "/view/laudo/dowloadArquivos/createDowloadArquivos.jsf", true), "dowloadArquivos");
        create(new Permissao("dowloadArquivos.list", "Consulta de Dowload Arquivos", "/view/laudo/dowloadArquivos/listDowloadArquivos.jsf", true), "dowloadArquivos");
        create(new Permissao("dowloadArquivos.audit", "Auditoria de Dowload Arquivos"), "dowloadArquivos");
        create(new Permissao("dowloadArquivos.delete", "Exclusão de Dowload Arquivos"), "dowloadArquivos");
