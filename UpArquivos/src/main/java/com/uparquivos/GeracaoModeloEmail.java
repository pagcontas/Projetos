...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        salvarModeloEmail("[UpArquivos] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[UpArquivos] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
