package com.uparquivos;

import com.uparquivos.dao.controleacesso.PermissaoDAO;
...
public class GeracaoPermissao {
    ...
    public void generate() {
        ...
        //Base Legal
        create(new Permissao("baseLegal", "Base Legal", true), null);
        create(new Permissao("baseLegal.create", "Cadastro de Base Legal", "/view/arquivos/baseLegal/createBaseLegal.jsf", true), "baseLegal");
        create(new Permissao("baseLegal.list", "Consulta de Base Legal", "/view/arquivos/baseLegal/listBaseLegal.jsf", true), "baseLegal");
        create(new Permissao("baseLegal.audit", "Auditoria de Base Legal"), "baseLegal");
        create(new Permissao("baseLegal.delete", "Exclusão de Base Legal"), "baseLegal");
